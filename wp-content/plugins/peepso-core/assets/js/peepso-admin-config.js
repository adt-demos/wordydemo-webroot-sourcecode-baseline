		...
		.on(
			...
			_.throttle(function () {
				var $first = $('select[name=brute_force_max_retries]'),
					$last = $('select[name=brute_force_whitelist_ip]'),
					$wrapper;
	...
	$(document).ready(function () {
		...
		$('input[name=site_registration_disabled]')
			.on(
				'click',
				_.throttle(function () {
					var $confirm = $('input[name=registration_confirm_email_field]'),
						$enableSSL = $('input[name=site_registration_enable_ssl]'),
						$wrapper = $confirm.add($enableSSL).closest('.form-group');
		...
		// Toggle reCAPTCHA
		$('input[name=site_registration_recaptcha_enable]')
			.on(
				'click',
				_.throttle(function () {
		...
		$('input[name=site_registration_enableterms]')
			.on(
				'click',
				_.throttle(function () {
					var $terms = $('textarea[name=site_registration_terms]'),
						$wrapper = $terms.closest('.form-group');
		...
		$('input[name=site_registration_enableprivacy]')
			.on(
				'click',
				_.throttle(function () {
					var $privacy = $('textarea[name=site_registration_privacy]'),
						$wrapper = $privacy.closest('.form-group');
